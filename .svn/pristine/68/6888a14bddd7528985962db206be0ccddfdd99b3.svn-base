...
(function($) {
	...
	Galleria.addTheme({
				...
				init : function(options) {
					...
					// cache some stuff
					var info = this.$('info-link,info-close,info-text'), touch = Galleria.TOUCH, click = touch ? 'touchstart'
							: 'click';
					...
					this.bind('loadstart', function(e) {
						...
						$(e.thumbTarget).css('opacity', 1).parent().siblings()
								.children().css('opacity', 0.6);
					});

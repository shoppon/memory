/**
 * Galleria Classic Theme 2012-08-08 http://galleria.io
 * 
...
(function (a) {
    Galleria.addTheme({
        ...
        init: function (b) {
            Galleria.requires(1.28, "This version of Classic theme requires Galleria 1.2.8 or later"), this.addElement("info-link", "info-close"), this.append({
            ...
            function (b) {
                d ? a(b.thumbTarget).css("opacity",
                this.getIndex() ? 1 : .6) : (a(b.thumbTarget).css("opacity", .6).parent().hover(function () {
            ...
            this.bind("loadstart", function (b) {
                b.cached || this.$("loader").show().fadeTo(200, .4),
                this.$("info").toggle(this.hasInfo()), a(b.thumbTarget).css("opacity", 1).parent().siblings().children().css("opacity", .6)
            }),

/**
 * Galleria v 1.2.9 2013-01-10 http://galleria.io
 * 
 ...
 */ (function (a) {
	 var b, c = this,
        ...
        s = "data ready thumbnail loadstart loadfinish image play pause progress fullscreen_enter fullscreen_exit idle_enter idle_exit rescale lightbox_open lightbox_close lightbox_image",
        t = function () {
            var b = [];
            return a.each(s.split(" "), function (a, c) {
        ...
        u = function (b) {
            ...
            return a.inArray(b, t) > -1 ? Galleria[b.toUpperCase()] : b
        }, w = {
            youtube: {
                ...
                getThumb: function (b, d, e) {
                    e = e || n, a.getJSON(c.location.protocol + "//gdata.youtube.com/feeds/api/videos/" + b + "?v=2&alt=json-in-script&callback=?", function (a) {
                        try {
                            d(a.entry.media$group.media$thumbnail[0].url)
                        } catch (b) {
                            e()
                        }
                    }).error(e)
            ...
            support: function () {
                var a = q().html;
                return !r && (a.requestFullscreen || a.mozRequestFullScreen || a.webkitRequestFullScreen)
            }(),
            callback: n,
            enter: function (a, b, c) {
                this.instance = a, this.callback = b || n, c = c || q().html, c.requestFullscreen ? c.requestFullscreen() : c.mozRequestFullScreen ? c.mozRequestFullScreen() : c.webkitRequestFullScreen && c.webkitRequestFullScreen()
            },
            exit: function (a) {
            ...
            listen: function () {
                ...
                var a = function () {
                    if (!y.instance) return;
                    var a = y.instance._fullscreen;
                    d.fullscreen || d.mozFullScreen || d.webkitIsFullScreen ? a._enter(y.callback) : a._exit(y.callback)
                };
        ...
        D = [],
        E = function (b) {
            Galleria.theme = b, a.each(D, function (a, b) {
            ...
            return {
                ...
                animate: function () {
                    ...
                    return function (d, q, r) {
                        ...
                        r.stop && (d.unbind(e), h(d)), i = !1, a.each(q, function (a, b) {
                            p = d.css(a), F.parseValue(p) != F.parseValue(b) && (i = !0), d.css(a, p)
                        });
                        if (!i) {
                            ...
                            return function () {
                                ...
                                if (Galleria.WEBKIT && Galleria.TOUCH) {
                                    m = {}, o = [0, 0, 0], a.each(["left", "top"], function (a, c) {
                                        c in d && (o[a] = F.parseValue(d[c]) - F.parseValue(b.css(c)) + "px", m[c] = d[c], delete d[c])
                                    });
                ...
                revertStyles: function () {
                    a.each(F.array(arguments), function (b, c) {
                ...
                hide: function (a, b, c) {
                    ...
                    if (b) {
                        var g = p < 9 && a ? function () {
                                F.removeAlpha(a), a.style.visibility = "hidden", c.call(a)
                            } : c;
                        F.animate(a, f, {
                            duration: b,
                            complete: g,
                    ...
                    } else p < 9 && a ? (F.removeAlpha(a), a.style.visibility = "hidden") : e.css(f)
                },
                show: function (a, b, c) {
                    c = c || n;
                    var d = F.elem(a),
                    ...
                    if (b) {
                        ...
                        var h = p < 9 && a ? function () {
                                g.opacity == 1 && F.removeAlpha(a), c.call(a)
                            } : c;
                        F.animate(a, g, {
                            duration: b,
                            complete: h,
                    ...
                    } else p < 9 && g.opacity == 1 && a ? (F.removeAlpha(a), a.style.visibility = "visible") : e.css(g)
                },
                ...
                insertStyleTag: function (b, c) {
                    if (c && a("#" + c).length) return;
                    var e = d.createElement("style");
                    c && (e.id = c), q().head.appendChild(e);
                    if (e.styleSheet) e.styleSheet.cssText = b;
                    else {
                        var f = d.createTextNode(b);
                        e.appendChild(f)
                    }
                },
                ...
                loadCSS: function (c, e, f) {
                    ...
                    if (typeof f == "function") {
                        ...
                        F.wait({
                            ...
                            error: function () {
                                j.remove(), Galleria.raise("Theme CSS could not load after 20 sec. " + Galleria.QUIRK ? "Your browser is in Quirks Mode, please add a correct doctype." : "Please download the latest theme at http://galleria.io/customer/.", !0)
                            },
                            timeout: 2e4
                        })
                    }
        ...
        G = function () {
            var b = function (b, c, d, e) {
                ...
                d ? (h.opacity = 0, i.opacity = 1) : h.opacity = 1, a(b.next).css(h), F.animate(b.next, i, {
                    duration: b.speed,
                    complete: function (a) {
                        return function () {
                            c(), a.css({
                    ...
                    left: g * (b.rewind ? 1 : -1)
                }, d && (h.opacity = 1, i.opacity = 0), a(b.prev).css(h), F.animate(b.prev, i, {
                    duration: b.speed,
                    queue: !1,
                    easing: f,
                    complete: function () {
            ...
            return {
                active: !1,
                init: function (a, b, c) {
                    G.effects.hasOwnProperty(a) && G.effects[a].call(this, b, c)
                },
                effects: {
                    fade: function (b, c) {
                        a(b.next).css({
                            ...
                            duration: b.speed,
                            complete: c
                        }), b.prev && (a(b.prev).css("opacity", 1).show(), F.animate(b.prev, {
                            opacity: 0
                        }, {
                            duration: b.speed
                        }))
                    ...
                    fadeslide: function (a, c) {
                        b.apply(this, F.array(arguments).concat([!0]))
                    },
                    doorslide: function (a, c) {
                        b.apply(this, F.array(arguments).concat([!1, !0]))
                    }
                }
            }
        }();
    y.listen(), Galleria = function () {
        ...
        var h = "container stage images image-nav image-nav-left image-nav-right info info-text info-title info-description thumbnails thumbnails-list thumbnails-container thumb-nav-left thumb-nav-right loader counter tooltip",
            i = "current total";
        a.each(h.split(" "), function (a, b) {
            g._dom[b] = F.create("galleria-" + b)
        }), a.each(i.split(" "), function (a, b) {
            g._dom[b] = F.create("galleria-" + b, "span")
        });
        var j = this._keyboard = {
            ...
            init: function () {
                ...
                F.insertStyleTag(a, "galleria-tooltip"), g.$("tooltip").css({
                    opacity: .8,
                    visibility: "visible",
                    display: "none"
                })
            ...
            move: function (a) {
                var b = g.getMousePosition(a).x,
                    c = g.getMousePosition(a).y,
                    d = g.$("tooltip"),
                    e = b,
                    f = c,
                    h = d.outerHeight(!0) + 1,
                    i = d.outerWidth(!0),
                    j = h + 15,
                    k = g.$("container").width() - i - 2,
                    l = g.$("container").height() - h - 2;
                !isNaN(e) && !isNaN(f) && (e += 10, f -= h + 8, e = Math.max(0, Math.min(k, e)), f = Math.max(0, Math.min(l, f)), c < j && (f = j), d.css({
                    left: e,
                    top: f
                }))
            },
            bind: function (b, c) {
                ...
                var d = function () {
                    g.$("container").unbind("mousemove", m.move), g.clearTimer(m.timer), g.$("tooltip").stop().animate({
                        opacity: 0
                    }, 200, function () {
                        g.$("tooltip").hide(), g.addTimer(m.swapTimer, function () {
                            m.open = !1
                        }, 1e3)
                    })
                }, e = function (b, c) {
                    m.define(b, c), a(b).hover(function () {
                        g.clearTimer(m.swapTimer), g.$("container").unbind("mousemove", m.move).bind("mousemove", m.move).trigger("mousemove"), m.show(b), g.addTimer(m.timer, function () {
                ...
                typeof c == "string" ? e(b in g._dom ? g.get(b) : b, c) : a.each(b, function (a, b) {
                    e(g.get(a), b)
                })
            },
            show: function (b) {
            ...
            parseCallback: function (b, c) {
                return G.active ? function () {
                    typeof b == "function" && b.call(g);
                    var d = g._controls.getActive(),
                        e = g._controls.getNext();
                    g._scaleImage(e), g._scaleImage(d), c && g._options.trueFullscreen && a(d.container).add(e.container).trigger("transitionend")
                } : b
            },
            enter: function (a) {
                a = n.parseCallback(a, !0), g._options.trueFullscreen && y.support ? (n.active = !0, F.forceStyles(g.get("container"), {
                    width: "100%",
                    height: "100%"
                }), g.rescale(), Galleria.MAC ? Galleria.WEBKIT ? (g.$("container").css("opacity", 0).addClass("fullscreen"), c.setTimeout(function () {
                    n.scale(), g.$("container").css("opacity", 1)
                }, 50)) : (g.$("stage").css("opacity", 0), c.setTimeout(function () {
                    n.scale(), g.$("stage").css("opacity", 1)
                }, 4)) : g.$("container").addClass("fullscreen"), f.resize(n.scale), y.enter(g, a, g.get("container"))) : (n.scrolled = f.scrollTop(), c.scrollTo(0, 0), n._enter(a))
            },
            _enter: function (e) {
                n.active = !0, r && (n.iframe = function () {
                    var b, e = d.referrer,
                        f = d.createElement("a"),
                        g = c.location;
                    return f.href = e, f.protocol != g.protocol || f.hostname != g.hostname || f.port != g.port ? (Galleria.raise("Parent fullscreen not available. Iframe protocol, domains and ports must match."), !1) : (n.pd = c.parent.document, a(n.pd).find("iframe").each(function () {
                        var a = this.contentDocument || this.contentWindow.document;
                        if (a === d) return b = this, !1
                    }), b)
                }()), F.hide(g.getActiveImage()), r && n.iframe && (n.iframe.scrolled = a(c.parent).scrollTop(), c.parent.scrollTo(0, 0));
                var h = g.getData(),
                    i = g._options,
                    j = !g._options.trueFullscreen || !y.support,
                    k = {
                        height: "100%",
                        overflow: "hidden",
                        margin: 0,
                ...
                j && (g.$("container").addClass("fullscreen"), F.forceStyles(g.get("container"), {
                    position: "fixed",
                    top: 0,
                    left: 0,
                    width: "100%",
                    height: "100%",
                    zIndex: 1e4
                }), F.forceStyles(q().html, k), F.forceStyles(q().body, k)), r && n.iframe && (F.forceStyles(n.pd.documentElement, k), F.forceStyles(n.pd.body, k), F.forceStyles(n.iframe, a.extend(k, {
                    width: "100%",
                    height: "100%",
                    top: 0,
                    left: 0,
                    ...
                    zIndex: 1e4,
                    border: "none"
                }))), n.keymap = a.extend({}, g._keyboard.map), g.attachKeyboard({
                    escape: g.exitFullscreen,
                    right: g.next,
                    left: g.prev
                }), n.crop = i.imageCrop, i.fullscreenCrop != b && (i.imageCrop = i.fullscreenCrop);
                if (h && h.big && h.image !== h.big) {
                    var l = new Galleria.Picture,
                        m = l.isCached(h.big),
                        o = g.getIndex(),
                        p = g._thumbnails[o];
                    g.trigger({
                ...
                g.rescale(function () {
                    g.addTimer(!1, function () {
                        j && F.show(g.getActiveImage()), typeof e == "function" && e.call(g)
                    }, 100), g.trigger(Galleria.FULLSCREEN_ENTER)
                }), j ? f.resize(n.scale) : F.show(g.getActiveImage())
            },
            scale: function () {
                g.rescale()
            },
            exit: function (a) {
                a = n.parseCallback(a), g._options.trueFullscreen && y.support ? y.exit(a) : n._exit(a)
            },
            _exit: function (a) {
                n.active = !1;
                var b = !g._options.trueFullscreen || !y.support;
                g.$("container").removeClass("fullscreen"), b && (F.hide(g.getActiveImage()), F.revertStyles(g.get("container"), q().html, q().body), c.scrollTo(0, n.scrolled)), r && n.iframe && (F.revertStyles(n.pd.documentElement, n.pd.body, n.iframe), n.iframe.scrolled && c.parent.scrollTo(0, n.iframe.scrolled)), g.detachKeyboard(), g.attachKeyboard(n.keymap), g._options.imageCrop = n.crop;
                var d = g.getData().big,
                    e = g._controls.getActive().image;
                !g.getData().iframe && e && d && d == e.src && c.setTimeout(function (a) {
                    return function () {
                        e.src = a
                    }
                }(g.getData().image), 1), g.rescale(function () {
                    g.addTimer(!1, function () {
                        b && F.show(g.getActiveImage()), typeof a == "function" && a.call(g), f.trigger("resize")
                    }, 50), g.trigger(Galleria.FULLSCREEN_EXIT)
                }), f.unbind("resize", n.scale)
            }
        }, o = this._idle = {
            trunk: [],
            bound: !1,
            ...
            add: function (b, c, d, e) {
                if (!b) return;
                o.bound || o.addEvent(), b = a(b), typeof d == "boolean" && (e = d, d = {}), d = d || {};
                var f = {}, g;
                ...
                b.data("idle", {
                    ...
                    complete: !0,
                    busy: !1
                }), e ? b.css(c) : o.addTimer(), o.trunk.push(b)
            },
            remove: function (b) {
                b = a(b), a.each(o.trunk, function (a, c) {
                    c && c.length && !c.not(b).length && (b.css(b.data("idle").from), o.trunk.splice(a, 1))
                }), o.trunk.length || (o.removeEvent(), g.clearTimer(o.timer))
            },
            addEvent: function () {
                o.bound = !0, g.$("container").bind("mousemove click", o.showAll), g._options.idleMode == "hover" && g.$("container").bind("mouseleave", o.hide)
            },
            removeEvent: function () {
                o.bound = !1, g.$("container").bind("mousemove click", o.showAll), g._options.idleMode == "hover" && g.$("container").unbind("mouseleave", o.hide)
            },
            addTimer: function () {
                if (g._options.idleMode == "hover") return;
            ...
            hide: function () {
                ...
                var b = o.trunk.length;
                a.each(o.trunk, function (a, c) {
                    var d = c.data("idle");
                    if (!d) return;
                    c.data("idle").complete = !1, F.animate(c, d.to, {
            ...
            showAll: function () {
                g.clearTimer("idle"), a.each(o.trunk, function (a, b) {
                    o.show(b)
                })
            },
            show: function (b) {
                var c = b.data("idle");
                if (!o.active || !c.busy && !c.complete) c.busy = !0, g.trigger(Galleria.IDLE_EXIT), g.clearTimer("idle"), F.animate(b, c.from, {
                    duration: g._options.idleSpeed / 2,
                    complete: function () {
                        o.active = !0, a(b).data("idle").busy = !1, a(b).data("idle").complete = !0
                    }
                });
                o.addTimer()
            }
            ...
            init: function () {
                ...
                p && p > 7 && (i.nextholder += "background:#000;filter:alpha(opacity=0);", i.prevholder += "background:#000;filter:alpha(opacity=0);"), a.each(i, function (a, b) {
                    e += ".galleria-" + h + a + "{" + b + "}"
                }), e += ".galleria-" + h + "box.iframe .galleria-" + h + "prevholder," + ".galleria-" + h + "box.iframe .galleria-" + h + "nextholder{" + "width:100px;height:100px;top:50%;margin-top:-70px}", F.insertStyleTag(e, "galleria-lightbox"), a.each(b.split(" "), function (a, b) {
                ...
                }), g.append(k), a(c.image).append(s.image.container), a(q().body).append(c.overlay, c.box), F.optimizeTouch(c.box), j(a(c.close).bind("click", s.hide).html("&#215;")), a.each(["Prev", "Next"], function (b, d) {
            ...
            rescale: function (b) {
                var c = Math.min(f.width() - 40, s.width),
                    d = Math.min(f.height() - 60, s.height),
                    e = Math.min(c / s.width, d / s.height),
                    h = Math.round(s.width * e) + 40,
                    i = Math.round(s.height * e) + 60,
                    j = {
                        width: h,
                        height: i,
                ...
                b ? a(s.elems.box).css(j) : a(s.elems.box).animate(j, {
                    ...
                    complete: function () {
                        var b = s.image,
                            c = g._options.lightboxFadeSpeed;
                        g.trigger({
                            type: Galleria.LIGHTBOX_IMAGE,
                            imageTarget: b.image
                        }), a(b.container).show(), a(b.image).animate({
                            opacity: 1
                        }, c), F.show(s.elems.info, c)
                    }
                })
            },
            hide: function () {
                s.image.image = null, f.unbind("resize", s.rescale), a(s.elems.box).hide(), F.hide(s.elems.info), g.detachKeyboard(), g.attachKeyboard(s.keymap), s.keymap = !1, F.hide(s.elems.overlay, 200, function () {
            ...
            show: function (b) {
                ...
                s.image.isIframe = !! d.iframe, a(s.elems.box).toggleClass("iframe", !! d.iframe), s.image.load(d.iframe || d.big || d.image, function (h) {
                    if (h.isIframe) {
                        var i = a(c).width(),
                            j = a(c).height();
                        if (g._options.maxVideoSize) {
                            var k = Math.min(g._options.maxVideoSize / i, g._options.maxVideoSize / j);
                            k < 1 && (i *= k, j *= k)
                        }
                        s.width = i, s.height = j
                    } else s.width = h.original.width, s.height = h.original.height;
                    a(h.image).css({
                        width: h.isIframe ? "100%" : "100.1%",
                        height: h.isIframe ? "100%" : "100.1%",
                        top: 0,
                        zIndex: 99998,
                        opacity: 0,
                        visibility: "visible"
        ...
        init: function (c, d) {
            var e = this;
            d = u(d), this._original = {
                target: c,
                options: d,
                data: null
            }, this._target = this._dom.target = c.nodeName ? c : a(c).get(0), this._original.html = this._target.innerHTML, A.push(this);
            if (!this._target) {
        ...
        _init: function () {
            ...
            function (a) {
                ...
                b._options.height < 2 && (b._userRatio = b._ratio = b._options.height);
                var d = {
                    width: 0,
                    height: 0
                }, e = function () {
            ...
            }), F.hide(this.$("counter").append(this.get("current"), d.createTextNode(" / "), this.get("total"))), this.setCounter("&#8211;"), F.hide(b.get("tooltip")), this.$("container").addClass(Galleria.TOUCH ? "touch" : "notouch"), a.each(new Array(2), function (c) {
                var d = new Galleria.Picture;
                a(d.container).css({
                    position: "absolute",
                    top: 0,
                    left: 0
                }).prepend(b._layers[c] = a(F.create("galleria-layer")).css({
                    position: "absolute",
                    top: 0,
                    left: 0,
                    right: 0,
                ...
                e["show" + c.substr(0, 1).toUpperCase() + c.substr(1).replace(/-/, "")] === !1 && F.moveOut(b.get(c.toLowerCase()))
            ...
            return e.responsive && f.bind("resize", function () {
                ...
                var c = [0, 0],
                    ...
                    a) {
                        ...
                        F.timestamp() - h < 1e3 && Math.abs(c[0] - d[0]) > e && Math.abs(c[1] - d[1]) < f && (i.preventDefault(), b[c[0] > d[0] ? "next" : "prev"]()), c = d = [0, 0]
                    };
                a.bind(j.start, function (b) {
                    if (b.originalEvent.touches && b.originalEvent.touches.length > 1) return;
                    i = k(b), h = F.timestamp(), c = d = [i.pageX, i.pageY], a.bind(j.move, l).one(j.stop, m)
                })
            ...
            }())), F.optimizeTouch(this.get("container")), a.each(Galleria.on.binds, function (c, d) {
        ...
        _getWH: function () {
            ...
            return a.each(["width", "height"], function (a, g) {
                d._options[g] && typeof d._options[g] == "number" ? e[g] = d._options[g] : (f = [F.parseValue(b.css(g)), F.parseValue(c.css(g)), b[g](), c[g]()], d["_" + g] || f.splice(f.length, F.parseValue(b.css("min-" + g)), F.parseValue(c.css("min-" + g))), e[g] = Math.max.apply(Math, f))
            }), d._userRatio && (e.height = e.width * d._userRatio), e
        },
        _createThumbnails: function (b) {
                ...
                t = function (a) {
                    ...
                    b.scale({
                        ...
                        complete: function (b) {
                            ...
                            }), F.toggleQuality(b.image, k.thumbQuality === !0 || k.thumbQuality === "auto" && b.original.width < b.width * 3), h.iframe && i.length == 2 && i[0] in w ? w[i[0]].getThumb(i[1], function (a) {
                                return function (d) {
                                    a.src = d, x(b, c)
                                }
            ...
            for (; this._data[l]; l++) g = this._data[l], e = g.thumb || g.image, k.thumbnails !== !0 && s != "lazy" || !g.thumb && !g.image ? g.iframe || s === "empty" || s === "numbers" ? (f = {
                ...
                width: F.parseValue(t("width")),
                height: F.parseValue(t("height")),
                order: l,
                src: e
            ...
            }), h = e.split(":"), h.length == 2 && h[0] in w ? (f.video = !0, f.ready = !0, f.load(q, {
                height: f.data.height,
                width: f.data.height * 1.25
            }, y)) : s == "lazy" ? (i.addClass("lazy"), f.lazy = !0, f.load(q, {
                height: f.data.height,
                width: f.data.width
            })) : f.load(e, y), k.preload === "all" && f.preload(g.image)), a(f.container).add(k.keepSource && k.linkSourceImages ? g.original : null).data("index", l).bind(k.thumbEventType, v).data("thumbload", y), r === e && a(f.container).addClass("active"), this._thumbnails.push(f);
        ...
        _run: function () {
            ...
            d._createThumbnails(), F.wait({
                ...
                success: function () {
                    z.push(d), F.show(d.get("counter")), d._options.carousel && d._carousel.bindControls(), d._options.autoplay && (d.pause(), typeof d._options.autoplay == "number" && (d._playtime = d._options.autoplay), d._playing = !0);
                    if (d._firstrun) {
        ...
        load: function (b, c, d) {
            ...
            return this._data = [], this._thumbnails = [], this.$("thumbnails").empty(), typeof c == "function" && (d = c, c = null), b = b || f.dataSource, c = c || f.dataSelector, d = d || f.dataConfig, /^function Object/.test(b.constructor) && (b = [b]), b.constructor === Array ? this.validate(b) ? this._data = b : Galleria.raise("Load failed: JSON Array not valid.") : (c += ",.video,.iframe", a(b).find(c).each(function (b, c) {
                ...
                var f = {}, g = c.parent(),
                    h = g.attr("href"),
                    i = g.attr("rel");
                h && (c[0].nodeName == "IMG" || c.hasClass("video")) && x(h) ? f.video = h : h && c.hasClass("iframe") ? f.iframe = h : f.image = f.big = h, i && (f.big = i), a.each("big title description link layer".split(" "), function (a, b) {
        ...
        _parseData: function () {
            ...
            return a.each(this._data, function (d, e) {
                ...
                if ("video" in e) {
                    var f = x(e.video);
                    if (f) {
                        c.iframe = w[f.provider].embed(f.id) + function () {
        ...
        destroy: function () {
            return this.$("target").data("galleria", null), this.$("container").unbind("galleria"), this.get("target").innerHTML = this._original.html, this.clearTimer(), F.removeFromArray(A, this), F.removeFromArray(z, this), this
        },
        splice: function () {
            var a = this,
                b = F.array(arguments);
        ...
        bind: function (a, b) {
            return a = v(a), this.$("container").bind(a, this.proxy(b)), this
        },
        unbind: function (a) {
            return a = v(a), this.$("container").unbind(a), this
        },
        trigger: function (b) {
        ...
        addElement: function (b) {
            var c = this._dom;
            return a.each(F.array(arguments), function (a, b) {
                c[b] = F.create("galleria-" + b)
            }), this
        },
            ...
            var d = this,
                e, f = function (b) {
                    a(b.container).children(":first").css({
                        top: Math.max(0, F.parseValue(b.image.style.top)),
                        left: Math.max(0, F.parseValue(b.image.style.left)),
                        width: F.parseValue(b.image.width),
                        height: F.parseValue(b.image.height)
                    })
                };
            return c = a.extend({
        ...
        show: function (a, b, c) {
            if (this._queue.length > 3 || a === !1 || !this._options.queue && this._queue.stalled) return;
        ...
        _show: function () {
            ...
            var h = f.iframe || (this.isFullscreen() && "big" in f ? f.big : f.image),
                ...
                m = function () {
                    ...
                    return function () {
                        var j;
                        G.active = !1, F.toggleQuality(e.image, d._options.imageQuality), d._layers[d._controls.active].innerHTML = "", a(f.container).css({
                            zIndex: 0,
                            opacity: 0
                            ...
                            if (typeof a.which == "number" && a.which > 1) return;
                            ...
                            thumbTarget: i.image,
                            galleriaData: b
                        }), g.shift.call(d._queue), d._queue.stalled = !1, d._queue.length && d._show()
                    }
                }(f, j, i, e, l);
            ...
            F.show(j.container), j.isIframe = !! f.iframe, a(d._thumbnails[e.index].container).addClass("active").siblings(".active").removeClass("active"), d.trigger({
                type: Galleria.LOADSTART,
                cached: k,
                index: e.index,
                rewind: e.rewind,
                ...
                thumbTarget: l.image,
                galleriaData: f
            }), d._queue.stalled = !0, j.load(h, function (c) {
                var g = a(d._layers[1 - d._controls.active]).html(f.layer || "").hide();
                d._scaleImage(c, {
                    complete: function (c) {
                        "image" in i && F.toggleQuality(i.image, !1), F.toggleQuality(c.image, !1), d.removePan(), d.setInfo(e.index), d.setCounter(e.index), f.layer && (g.show(), (f.link || d._options.lightbox || d._options.clicknext) && g.css("cursor", "pointer").unbind("mouseup").mouseup(m));
                        ...
                        if (h in G.effects == 0) n();
                            ...
                            G.active = !0, G.init.call(d, h, j, n)
                        }
                        d.trigger({
                            type: Galleria.LOADFINISH,
                            cached: k,
        ...
        setCounter: function (a) {
            ...
            if (p) {
                var b = this.$("counter"),
                    c = b.css("opacity");
                parseInt(c, 10) === 1 ? F.removeAlpha(b[0]) : this.$("counter").css("opacity", c)
            }
            return this
        },
        setInfo: function (b) {
        ...
        b.name || Galleria.raise("No theme name specified"), typeof b.defaults != "object" ? b.defaults = {} : b.defaults = u(b.defaults);
        var d = !1,
            e;
        return typeof b.css == "string" ? (a("link").each(function (a, c) {
            e = new RegExp(b.css);
            if (e.test(c.href)) return d = !0, E(b), !1
            ...
            e = new RegExp("galleria\\." + b.name.toLowerCase() + "\\."), e.test(f.src) && (d = f.src.replace(/[^\/]*$/, "") + b.css, c.setTimeout(function () {
                F.loadCSS(d, "galleria-theme", function () {
                    E(b)
                })
            }, 1))
        }), d || Galleria.raise("No theme CSS loaded")) : E(b), b
    }, Galleria.loadTheme = function (b, d) {
        if (a("script").filter(function () {
            return a(this).attr("src") == b
        }).length) return;
        var e = !1,
            f;
        return a(c).load(function () {
            e || (f = c.setTimeout(function () {
                !e && !Galleria.theme && Galleria.raise("Galleria had problems loading theme at " + b + ". Please check theme path or load manually.", !0)
            }, 2e4))
        }), Galleria.unloadTheme(), F.loadScript(b, function () {
            e = !0, c.clearTimeout(f)
        }), Galleria
    }, Galleria.unloadTheme = function () {
        return typeof Galleria.theme == "object" && (a("script").each(function (b, c) {
            (new RegExp("galleria\\." + Galleria.theme.name + "\\.")).test(c.src) && a(c).remove()
        }), Galleria.theme = b), Galleria
        ...
        if (!b) return;
        c = c || n;
        var d = b + c.toString().replace(/\s/g, "") + F.timestamp();
        ...
        return a.isFunction(c) && (c = {
            extend: c
        }), a(b || "#galleria").galleria(c), Galleria
    }, Galleria.addTransition = function (a, b) {
        return G.effects[a] = b, Galleria
    }, Galleria.utils = F, Galleria.log = function () {
        var b = F.array(arguments);
        ...
        return typeof b != "function" ? Galleria : (a.each(z, function (a, c) {
            b.call(c, c._options)
        ...
        if (i) {
            ...
            if (B) return;
            B = !0, c = !1, g("Gallery could not load.")
        }
        ...
        this.id = b || null, this.image = null, this.container = F.create("galleria-image"), a(this.container).css({
            overflow: "hidden",
            position: "relative"
        }), this.original = {
            width: 0,
        ...
        load: function (b, d, e) {
            ...
            this.image = new Image, Galleria.IE8 && a(this.image).css("filter", "inherit");
            var g = 0,
                h = !1,
                i = !1,
                j = a(this.container),
            ...
            return j.find("iframe,img").remove(), l.css("display", "block"), F.hide(this.image), a.each("minWidth minHeight maxWidth maxHeight".split(" "), function (a, b) {
        ...
        scale: function (c) {
            ...
            if (this.isIframe) {
                var e = c.width,
                    ...
                    g, h;
                if (c.iframelimit) {
                    var i = Math.min(c.iframelimit / e, c.iframelimit / f);
                    i < 1 ? (g = e * i, h = f * i, a(this.image).css({
                        top: f / 2 - h / 2,
                        left: e / 2 - g / 2,
                        position: "absolute"
                    })) : a(this.image).css({
                ...
                a(this.image).width(g || e).height(h || f).removeAttr("width").removeAttr("height"), a(this.container).width(e).height(f), c.complete.call(d, d);
                try {
            ...
            var k, l, m = a(d.container),
                o;
            return F.wait({
                until: function () {
                    return k = c.width || m.width() || F.parseValue(m.css("width")), l = c.height || m.height() || F.parseValue(m.css("height")), k && l
                },
                success: function () {
                    var b = (k - c.margin * 2) / d.original.width,
                        e = (l - c.margin * 2) / d.original.height,
                        f = Math.min(b, e),
                        g = Math.max(b, e),
                        h = {
                            "true": g,
                            ...
                            height: e,
                            "false": f,
                            landscape: d.original.width > d.original.height ? g : f,
                            portrait: d.original.width < d.original.height ? g : f
                        }, i = h[c.crop.toString()],
                        j = "";
                    c.max && (i = Math.min(c.max, i)), c.min && (i = Math.max(c.min, i)), a.each(["width", "height"], function (b, c) {
                        a(d.image)[c](d[c] = d.image[c] = Math.round(d.original[c] * i))
                    }), a(d.container).width(k).height(l), c.canvas && C && (C.elem.width = d.width, C.elem.height = d.height, j = d.image.src + ":" + d.width + "x" + d.height, d.image.src = C.cache[j] || function (a) {
                        C.context.drawImage(d.image, 0, 0, d.original.width * i, d.original.height * i);
                        try {
                            return o = C.elem.toDataURL(), C.length += o.length, C.cache[a] = o, o
                        } catch (b) {
                            return d.image.src
                        }
                    }(j));
                    var m = {}, n = {}, p = function (b, c, e) {
                        var f = 0;
                        if (/\%/.test(b)) {
                            var g = parseInt(b, 10) / 100,
                                h = d.image[c] || a(d.image)[c]();
                            f = Math.ceil(h * -1 * g + e * g)
                        } else f = F.parseValue(b);
                        return f
                    }, q = {
                        top: {
                            top: 0
                    ...
                    a.each(c.position.toLowerCase().split(" "), function (a, b) {
                        b === "center" && (b = "50%"), m[a ? "top" : "left"] = b
                    }), a.each(m, function (b, c) {
                        q.hasOwnProperty(c) && a.extend(n, q[c])
                    }), m = m.top ? a.extend(m, n) : n, m = a.extend({
                        top: "50%",
                        left: "50%"
                    }, m), a(d.image).css({
                        position: "absolute",
                        top: p(m.top, "height", l),
                        left: p(m.left, "width", k)
        ...
        return a(this).length ? this.each(function () {
            a.data(this, "galleria") && (a.data(this, "galleria").destroy(), a(this).find("*").hide()), a.data(this, "galleria", (new Galleria).init(this, b))
        }) : (a(function () {
